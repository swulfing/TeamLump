 ...
 * Only the samples that were lengthed have number of fish per tow specified. Otherwise, we just know that at least one fish was caught on this tow, making the WEIGHT_TOW column useless in non-lengthed observations
 * TOW IDs in NOAA Observer data were eliminated due to confidentiality
 * Some weights were confusing (See boxplot below)


```{r setup, include=FALSE, cache=TRUE, echo = FALSE, warning=FALSE}
